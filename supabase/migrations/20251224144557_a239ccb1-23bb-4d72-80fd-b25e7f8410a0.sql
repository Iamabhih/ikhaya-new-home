-- Fix create_user_from_order function to use extensions schema for pgcrypto functions
...
BEGIN
  ...
  -- Using extensions.crypt and extensions.gen_salt to properly reference pgcrypto functions
