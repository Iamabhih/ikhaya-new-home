...
-- Add site settings for promotions configuration
INSERT INTO public.site_settings (setting_key, setting_value, description) VALUES
('promotions_page_enabled', true, 'Enable/disable the promotions page'),
('promotions_page_title', 'Weekly Promotions', 'Title for the promotions page'),
('promotions_page_description', 'Check out our latest weekly promotions and special offers!', 'Description for the promotions page'),
('promotions_auto_archive', true, 'Automatically archive old promotions');
