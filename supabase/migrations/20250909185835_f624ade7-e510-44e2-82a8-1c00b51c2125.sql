-- Fix the update_cart_session_metrics function to properly handle cart_session_id
...
-- Fix the update_customer_engagement function to properly handle cart_session_id
