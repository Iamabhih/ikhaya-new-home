...
function simpleMD5(str: string): string {
  // This is a simplified implementation for frontend use
  // For production, use a proper crypto library or server-side generation
...
export const generateSignature = (data: Record<string, string>, passPhrase: string): string => {
  try {
    ...
    // Use simple MD5 implementation
    return simpleMD5(pfOutput);
  } catch (error) {
...
export const initializePayfastPayment = (
  ...
  // Set base URL for PayFast API - ALWAYS use payfast.io domain
