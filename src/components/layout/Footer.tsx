        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-white font-semibold text-sm">Manufacturer - Importer - Distributor</p>
              <p className="text-white/50 text-xs leading-relaxed uppercase">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-white uppercase tracking-wider text-sm">Quick Links</h3>
            <div className="space-y-3">
              ...
              <Link to="/about" className="block text-sm text-white/50 hover:text-white transition-colors">
                About Us
              </Link>
              <Link
                to="/contact"
          ...
          {/* Customer Service */}
          <div className="space-y-4">
            <h3 className="font-semibold text-white uppercase tracking-wider text-sm">Support</h3>
            <div className="space-y-3">
              <Link
                to="/shipping"
                className="block text-sm text-white/50 hover:text-white transition-colors"
              ...
              <Link to="/faq" className="block text-sm text-white/50 hover:text-white transition-colors">
                FAQ
              </Link>
              <Link
                to="/privacy"
          ...
          <div className="space-y-6">
            <h3 className="font-semibold text-white uppercase tracking-wider text-sm">Our Locations</h3>
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="font-medium text-white text-sm">OZZ CASH & CARRY</p>
            ...
            <div className="space-y-3 pt-2">
              <a
                ...
                className="flex items-center space-x-2 text-sm text-white/50 hover:text-white transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-sm text-white/50 hover:text-green-400 transition-colors"
              >
