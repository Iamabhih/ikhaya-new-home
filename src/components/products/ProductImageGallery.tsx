      ...
      <div className="space-y-4">
        ...
        >
          ...
          <Button
            variant="secondary"
            size="icon"
            className="absolute top-4 right-4 bg-black/80 hover:bg-black/90 text-white border border-white/20 shadow-premium opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110"
          ...
          {sortedImages.length > 1 && (
            <>
              <Button
                variant="secondary"
                size="icon"
                className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/80 hover:bg-black/90 text-white border border-white/20 shadow-premium opacity-90 hover:opacity-100 transition-all duration-300 hover:scale-110"
              ...
              <Button
                variant="secondary"
                size="icon"
                className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/80 hover:bg-black/90 text-white border border-white/20 shadow-premium opacity-90 hover:opacity-100 transition-all duration-300 hover:scale-110"
                onClick={goToNext}
              >
